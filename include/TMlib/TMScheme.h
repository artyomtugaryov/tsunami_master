...
namespace TM {
    namespace Scheme {
        ...
        public:
            ...
            virtual void calculation(const std::shared_ptr<TM::Map::MapAreaWorker>&, const double) = 0;
            ...
            virtual double getTimeStep(const double &dPhi, const double &dTetta) const = 0;
